...
#
#SBATCH --job-name=1_Social_Processing
#SBATCH --output=/well/nichols/users/pra123/CBMR_neuroimage_paper/brain_real_dset/logs/out/slurm-%A_%a.out
#SBATCH --error=/well/nichols/users/pra123/CBMR_neuroimage_paper/brain_real_dset/logs/e/slurm-%A_%a.e
...
source ~/.bashrc 
cd CBMR_neuroimage_paper/brain_real_dset
